      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // Image + Title + Author with Blurred Background
            Center(
              child: Column(
                children: [
                  Stack(
                      ...
                      return StatefulBuilder(
                        builder: (context, setStateDialog) {
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              width: 300, // fixed width so dialog won't expand horizontally
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 12),
                                  SizedBox(
                                    height: 100, // fixed height for review input
                                    child: Scrollbar(
                                      child: SingleChildScrollView(
                                        child: TextField(
                                          controller: reviewController,
                                          maxLines: 3, // fixed number of visible lines, no expansion
            ...
            Center(
              child: Column(
                children: [
                  const SizedBox(height: 12),
                  Container(height: 2, width: 20, color: Color(0xFF3C090E)),
                  const SizedBox(height: 12),
                ],
              ),
            ),
